...
$('#day1').click(function () {
    "use strict";
    $('#table1day1').fadeIn('50');
    $('#table2day1').fadeIn('50');
    $('#table1day2').fadeOut('50');
    $('#table2day2').fadeOut('50');
    $('#bday1').css("opacity", "1");
    $('#bday2').css("opacity", "0.5");
    $('#day2').css("cursor","pointer");
    $("#day1").css("cursor","default");
});

$('#day2').click(function () {
    "use strict";
    $('#table1day1').fadeOut('50');
    $('#table2day1').fadeOut('50');
    $('#table1day2').fadeIn('50');
    $('#table2day2').fadeIn('50');
    $('#bday2').css("opacity", "1");
    $('#bday1').css("opacity", "0.5");
    $('#day2').css("cursor","default");
    $("#day1").css("cursor","pointer");
});
}else{
$('#day1').click(function () {
    "use strict";
    $('#mtable1day1').fadeIn('50');
    $('#mtable2day1').fadeIn('50');
    $('#mtable1day2').fadeOut('50');
    $('#mtable2day2').fadeOut('50');
    $('#bday1').css("opacity", "1");
    $('#bday2').css("opacity", "0.5");
    $('#day2').css("cursor","pointer");
    $("#day1").css("cursor","default");
...
$('#day2').click(function () {
    "use strict";
    $('#mtable1day1').fadeOut('50');
    $('#mtable2day1').fadeOut('50');
    $('#mtable1day2').fadeIn('50');
    $('#mtable2day2').fadeIn('50');
    $('#bday2').css("opacity", "1");
    $('#bday1').css("opacity", "0.5");
    $('#day2').css("cursor","default");
    $("#day1").css("cursor","pointer");
