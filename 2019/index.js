...
function draw() {
    ...
    var day1 = new Date();
    var day2 = new Date("2019/9/7");
    var width = window.innerWidth;
    var termDay = document.getElementById("termDay");
    
    if (Math.floor((day2 - day1 + 86400000 + 86400000) / 86400000) >= 100 && width >= 600) {
        termDay.innerHTML = Math.floor((day2 - day1 + 86400000 + 86400000) / 86400000);
        termDay.style.left = "calc(70% / 7.2)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) <= 99 && Math.floor((day2 - day1 + 86400000) / 86400000) >= 10 && width >= 600) {
        termDay.innerHTML = Math.floor((day2 - day1 + 86400000) / 86400000);
        termDay.style.left = "calc(90% / 7.2)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) <= 9 && Math.floor((day2 - day1 + 86400000) / 86400000) >= 1 && width >= 600) {
        termDay.innerHTML = Math.floor((day2 - day1 + 86400000) / 86400000);
        termDay.style.left = "calc(110% / 7.2)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) <= 0 && width >= 600) {
        termDay.innerHTML = "終了";
        termDay.style.left = "calc(80% / 7.2)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) >= 100 && width <= 600) {
        termDay.innerHTML = Math.floor((day2 - day1 + 86400000) / 86400000);
        termDay.style.left = "calc(15% / 4.5)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) <= 99 && Math.floor((day2 - day1 + 86400000) / 86400000) >= 10 && width <= 600) {
        termDay.innerHTML = Math.floor((day2 - day1 + 86400000) / 86400000);
        termDay.style.left = "calc(40% / 4.5)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) <= 9 && Math.floor((day2 - day1 + 86400000) / 86400000) >= 1 && width <= 600) {
        termDay.innerHTML = Math.floor((day2 - day1 + 86400000) / 86400000);
        termDay.style.left = "calc(65% / 4.5)";
    }
    if (Math.floor((day2 - day1 + 86400000) / 86400000) <= 0 && width <= 600) {
        termDay.innerHTML = "終了";
        termDay.style.left = "calc(40% / 4.5)";
